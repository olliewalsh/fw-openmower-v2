...
#ifndef WHEEL_SPEED_LIMIT_ESTIMATOR_HPP
#define WHEEL_SPEED_LIMIT_ESTIMATOR_HPP
...
class WheelSpeedLimitEstimator {
 public:
  ...
  float estimated_limit() const {
    return estimated_limit_;
  }
 ...
 private:
  ...
  float estimated_limit_ = 0;
};

#endif  // WHEEL_SPEED_LIMIT_ESTIMATOR_HPP
